  ...
  [3894],
  {
    ...
    38276: function (e) {
      ...
      if ("object" === typeof document && document.implementation) {
        ...
        l = function (e, t) {
          return t
            ? ((p.documentElement.querySelector(t).innerHTML = e), p)
          ...
          switch ((h && h[1] && (c = h[1].toLowerCase()), c)) {
            case t:
              return (
                (u = s(e)),
                i.test(e) ||
                  ((p = u.querySelector(n)) && p.parentNode.removeChild(p)),
                a.test(e) ||
                  ((p = u.querySelector(r)) && p.parentNode.removeChild(p)),
                u.querySelectorAll(t)
              );
            case n:
            case r:
              return (
                (d = (u = l(e)).querySelectorAll(c)),
                a.test(e) && i.test(e) ? d[0].parentNode.childNodes : d
              );
            default:
              return f ? f(e) : (p = l(e, r).querySelector(r)).childNodes;
          }
        });
    },
      ...
      (t.formatAttributes = d),
        (t.formatDOM = function e(t, n, r) {
          ...
          for (var o = [], i = 0, u = t.length; i < u; i++) {
            ...
            switch (f.nodeType) {
              case 1:
                (p = new l(h(f.nodeName), d(f.attributes))).children = e(
                  f.childNodes,
                  p
                );
                break;
      ...
      e.exports = function e(t, n) {
        for (
          ...
          if (((i = t[x]), v && y((u = n.replace(i)))))
            ...
            k > 1 && (p.key = x), g.push(m(i.name, p, f));
          } else {
    ...
    18139: function (e) {
      ...
      e.exports = function (e, s) {
        ...
        function m(e) {
          (this.start = e),
            (this.end = { line: p, column: f }),
            (this.source = s.source);
        }
        m.prototype.content = e;
        var y = [];
        function g(t) {
          var n = new Error(s.source + ":" + p + ":" + f + ": " + t);
          if (
            ((n.reason = t),
            (n.filename = s.source),
            (n.line = p),
    ...
    25935: function (e, t, n) {
      ...
      var r = n(30488),
        o = r.domToReact,
        i = (r.htmlToDOM, r.attributesToProps);
      r.Element;
      t.ZP = r;
    },
  },
