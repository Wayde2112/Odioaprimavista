                      ...
                      if (i.startsWith("/")) {
                        ...
                        return Promise.all([
                          ...
                          var n = o(t, 2),
                            i = n[0],
                            u = n[1].__rewrites,
                            c = M.addLocale(s.pathname, s.locale);
                          if (
                            b.isDynamicRoute(c) ||
                            (!a &&
                              i.includes(
                ...
                value: function (t, r, n, a, l) {
                  ...
                  return u(function () {
                    ...
                    return i(this, function (i) {
                      switch (i.label) {
                        case 0:
                          if (!H(r)) return te({ url: r, router: s }), [2, !1];
                          if (
                            ((u = a._h),
                            (f =
                              u ||
                        ...
                        case 8:
                          return i.sent(), te({ url: n, router: s }), [2, !1];
                        case 9:
                          return (
                            s.urlIsNew(W) || V || (t = "replaceState"),
                            (ae = n),
                            (Q = Q
                            ...
                            if (
                              ...
                              (X.pathname = G(Q, J)),
                                X.pathname !== Q &&
                                  ...
                                  (X.pathname = A.addBasePath(Q)),
                                  oe || (r = x.formatWithValidation(X)));
                          if (!H(n)) return te({ url: n, router: s }), [2, !1];
                          if (
                            ((ae = C.removeLocale(
                              R.removeBasePath(ae),
                              m.locale
                            ...
                            if (
                              ...
                              (ce = E.getRouteMatcher(fe)(se)),
                              (pe = (de = ue === se) ? F(ue, se, Y) : {}),
                              !ce || (de && !pe.result))
                            ) {
                              if (
                        ...
                        case 12:
                          if (
                            ...
                            return "redirect-internal" === ye.type
                              ? [2, s.change(t, ye.newUrl, ye.newAs, a)]
                              : (te({ url: ye.destination, router: s }),
                        ...
                        case 18:
                          return (
                            ...
                            !y &&
                            !V &&
                            I.compareRouterStates(qe, s.state)
                              ? [3, 20]
                              : [
                                  4,
                                  s.set(qe, ye, Ze).catch(function (e) {
                                    if (!e.cancelled) throw e;
                                    Se = Se || e;
                                  }),
                                ]
